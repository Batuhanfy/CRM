    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            ...
            <div class="alert alert-secondary material-shadow text-center" role="alert">
                <strong> Arkadaş ekleme panelinden </strong> istediğin bir kullanıcıyı <b>arkadaş olarak ekleyebilirsin.</b>
            </div>
            ...
            <?php endif; ?>
            <form method="post" action="<?php base_url('dashboard/addfriend');?>" class="row g-3">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />

                <div class="col-md-12">
                    <label for="fullnameInput" class="form-label">Mail:</label>
                    <input type="text" class="form-control" name="email" placeholder="Kullanıcı Mail Adresi">
                </div>

                <div class="col-12 text-end">
                    <button type="submit" class="btn btn-primary">Arkadaşlık İsteği Gönder</button>
                </div>
            </form>
        </div>
    </div>
