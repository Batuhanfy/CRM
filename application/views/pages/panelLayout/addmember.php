...
<div class="container-fluid" style="margin-top: 140px">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            ...
            <!-- Primary Alert -->
            <?php
            $proje = $this->General_Model->get('projects',['id'=>$project_id],'*');
            ?>
            <div class="alert alert-primary alert-dismissible border-2 bg-body-secondary fade show material-shadow" role="alert">
                <strong> Proje Adı: </strong> -  <b> <?php print_r($proje->project_name);?></b>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>

            <div class="alert alert-secondary material-shadow text-center" role="alert">
                <strong> Projeye üye davet panelinden </strong> istediğin bir kişiyi <b> projeyi görmesi üzerine ekleyebilirsin.</b>
            </div>
            ...
            <?php endif; ?>
            <form method="post" action="<?php base_url('dashboard/addmember');?>" class="row g-3">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                <input type="hidden" name="project_id" value="<?php echo $project_id; ?>" />

                <div class="col-md-12">
                    <label for="fullnameInput" class="form-label">E-Posta:</label>

                    <input type="text" class="form-control" name="membermail" placeholder="Eklemek istediğiniz kişinin e-postası">
                </div>

                <div class="col-12 text-end">
                    <button type="submit" class="btn btn-primary">Yetkilendir</button>
                </div>
            </form>
        </div>
    </div>
