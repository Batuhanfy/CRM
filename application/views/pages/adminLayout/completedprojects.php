        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Biten Projeler</li>
                </ol>
            </nav>
            <!-- Secondary Alert -->
            <div class="alert border-0 alert-secondary material-shadow" role="alert">
                <strong> Admin paneline hoşgeldiniz. </strong> bu sayfadan biten projeleri görüntüleyebilirsiniz.
            </div>
            ...
            <!-- Striped Rows --><div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php
                    $projects = $this->General_Model->getAll('projects',['status'=>'completed']);
