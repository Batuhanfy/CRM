...
|
*/
$config['base_url'] = 'https://crmpanel.batuhankorkmaz.com/';

$config['cors_allowed_origins'] = ['http://localhost:5173'];
$config['cors_allowed_methods'] = ['GET', 'POST', 'OPTIONS'];
...
|
*/
$config['encryption_key'] = hex2bin('d397f445d35102b4dbc2655230187f018e77a2a38ac3a8ac708d10d8a980a442');
